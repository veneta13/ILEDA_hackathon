...
def cluster(df, number_of_clusters=3):
    ...
    for pos in bar_positions:
        plt.text(pos + bar_width, 0 + first_axis[pos][1] / 10, all_axis[pos][0][0], ha='center', va='bottom',
                 rotation=90)
        plt.text(pos, 0 + second_axis[pos][1] / 10, all_axis[pos][1][0], ha='center', va='bottom', rotation=90)
        plt.text(pos - bar_width, 0 + third_axis[pos][1] / 10, all_axis[pos][2][0], ha='center', va='bottom',
                 rotation=90)
